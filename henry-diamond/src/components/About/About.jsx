            ...
            <Grid container>
                ...
                <Grid item xs={12}>
                  <Box bgcolor='#bdbdbd' boxShadow='4px 1px 8px #7a7a7a' mt={15} mb={3} mx={50} py={2} px={10}>
                    ...
                    Lautaro Ferreyra:
                    <Button href={'https://github.com/FerreyraLautaro'}>
                      <GitHubIcon/>
                    </Button>      
                    <Button href={'https://www.linkedin.com/in/lautaro-ferreyra-6713201ba/'}>
                      <LinkedInIcon/>
                    </Button>                   
                  </Box>
                </Grid>
                ...
                <Grid item xs={12}>
                  <Box bgcolor='#bdbdbd' boxShadow='4px 1px 8px #7a7a7a' my={2} mx={50} py={2} px={10}>
                    ...
                    <Button href={'https://github.com/chuno-st'}>
                      <GitHubIcon/>
                    </Button>      
                    <Button href={'https://www.linkedin.com/in/brunostauber/'}>
                      <LinkedInIcon/>
                    </Button>  
                  </Box>
                </Grid>  
                ...
                <Grid item xs={12}>
                  <Box bgcolor='#bdbdbd' boxShadow='4px 1px 8px #7a7a7a' my={2} mx={50} py={2} px={10}>
                    ...
                    <Button href={'https://github.com/lordW1lly'}>
                      <GitHubIcon/>
                    </Button>      
                    <Button href={'https://www.linkedin.com/in/sebasti%C3%A1n-d-engelstajn-4356271aa/'}>
                      <LinkedInIcon/>
                    </Button>  
                  </Box>             
                </Grid>
                ...
                <Grid item xs={12}>
                  <Box bgcolor='#bdbdbd' boxShadow='4px 1px 8px #7a7a7a' my={2} mx={50} py={2} px={10}>
                    ...
                    <Button href={'https://github.com/Agustlescano'}>
                      <GitHubIcon/>
                    </Button>      
                    <Button href={'https://www.linkedin.com/in/agust%C3%ADn-lescano-199484223/'}>
                      <LinkedInIcon/>
                    </Button>  
                  </Box>             
                </Grid>
                ...
                <Grid item xs={12}>
                  <Box bgcolor='#bdbdbd' boxShadow='4px 1px 8px #7a7a7a' my={2} mx={50} py={2} px={10}>
                    ...
                    <Button href={'https://github.com/Ccarit0'}>
                      <GitHubIcon/>
                    </Button>      
                    <Button href={'https://www.linkedin.com/in/carolina-castillo-andrada-088244238/'}>
                      <LinkedInIcon/>
                    </Button>  
                  </Box>             
                </Grid>
                ...
                <Grid item xs={12}>
                  <Box bgcolor='#bdbdbd' boxShadow='4px 1px 8px #7a7a7a' my={2} mx={50} py={2} px={10}>
                    ...
                    <Button href={'https://github.com/fransiri7'}>
                      <GitHubIcon/>
                    </Button>      
                    <Button href={''}>
                      <LinkedInIcon/>
                ...
                <Grid item xs={12}>
                  <Box bgcolor='#bdbdbd' boxShadow='4px 1px 8px #7a7a7a' my={2} mx={50} py={2} px={10}>
                    ...
                    <Button href={'https://github.com/soledadpetrino'}>
                      <GitHubIcon/>
                    </Button>      
                    <Button href={'https://www.linkedin.com/in/soledad-petrino/'}>
                      <LinkedInIcon/>
                    </Button>          
